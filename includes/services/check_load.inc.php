...
$check_cmd = \App\Facades\ObzoraConfig::get('nagios_plugins') . '/check_load ' . $params;
...
if (isset($rrd_filename)) {
    ...
    $check_graph['load'] .= ' LINE1.25:DS0#' . \App\Facades\ObzoraConfig::get('graph_colours.mixed.0') . ":'" . str_pad(substr('Load 1', 0, 15), 15) . "' ";
    ...
    $check_graph['load'] .= ' LINE1.25:DS1#' . \App\Facades\ObzoraConfig::get('graph_colours.mixed.1') . ":'" . str_pad(substr('Load 5', 0, 15), 15) . "' ";
    ...
    $check_graph['load'] .= ' LINE1.25:DS2#' . \App\Facades\ObzoraConfig::get('graph_colours.mixed.2') . ":'" . str_pad(substr('Load 15', 0, 15), 15) . "' ";
