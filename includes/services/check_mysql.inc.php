...
$check_cmd = \App\Facades\ObzoraConfig::get('nagios_plugins') . '/check_mysql -H ' . $service['hostname'] . ' ' . $dbname . ' ' . $service['service_param'];
...
if (isset($rrd_filename)) {
    ...
    $check_graph = [];
    $mixed_colours = \App\Facades\ObzoraConfig::get('graph_colours.mixed');
