...
if (file_exists(ObzoraConfig::get('install_dir') . "/includes/discovery/fdb-table/{$device['os']}.inc.php")) {
    require ObzoraConfig::get('install_dir') . "/includes/discovery/fdb-table/{$device['os']}.inc.php";
} elseif ($device['os'] == 'ios' || $device['os'] == 'iosxe' || $device['os'] == 'nxos') {
    //ios,iosxe,nxos are all Cisco
    include ObzoraConfig::get('install_dir') . '/includes/discovery/fdb-table/ios.inc.php';
}

if (empty($insert)) {
    // Check generic Q-BRIDGE-MIB and BRIDGE-MIB
    include ObzoraConfig::get('install_dir') . '/includes/discovery/fdb-table/bridge.inc.php';
}
