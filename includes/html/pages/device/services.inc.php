...
if (count($services) > '0') {
    ...
    foreach ($services as $service) {
        ...
        echo '<td class="col-sm-1 text-muted">' . \ObzoraNMS\Util\Time::formatInterval(time() - $service['service_changed']) . '</td>';
        ...
        if ($vars['view'] == 'details') {
            ...
            $check_ds = null;
            $check_script = \App\Facades\ObzoraConfig::get('install_dir') . '/includes/services/check_' . strtolower($service['service_type']) . '.inc.php';
