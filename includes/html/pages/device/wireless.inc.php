...
if ($vars['metric'] == 'overview') {
    foreach ($datas as $type) {
        ...
        include \App\Facades\ObzoraConfig::get('install_dir') . '/includes/html/print-device-graph.php';
    }
    ...
    foreach ($sensors as $sensor) {
        ...
        include \App\Facades\ObzoraConfig::get('install_dir') . '/includes/html/print-graphrow.inc.php';
