...
<table id="port-nd" class="table table-condensed table-hover table-striped">
    <thead>
        <tr>
            ...
            <th data-column-id="mac_oui" data-sortable="false" data-width="" data-visible="<?php echo \App\Facades\ObzoraConfig::get('mac_oui.enabled') ? 'true' : 'false' ?>" data-formatter="tooltip">Vendor</th>
    ...
    foreach($port->nd as $nd) {
        $vendor = \ObzoraNMS\Util\Mac::parse($nd->mac_address)->vendor();
