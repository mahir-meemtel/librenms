...
<table id="nac-grid" data-toggle="bootgrid" class="table table-hover table-condensed table-striped">
    <thead>
        <tr>
            ...
            <th data-column-id="mac_oui" data-formatter="tooltip" data-sortable="false" data-width="130px" data-visible="<?php echo \App\Facades\ObzoraConfig::get('mac_oui.enabled') ? 'true' : 'false' ?>">Vendor</th>
