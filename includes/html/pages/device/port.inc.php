...
if (ObzoraNMS\Plugins::countHooks('port_container') || \PluginManager::hasHooks(PortTabHook::class, ['port' => $port])) {
...
if (Auth::user()->hasGlobalAdmin() && \App\Facades\ObzoraConfig::get('enable_billing') == 1) {
