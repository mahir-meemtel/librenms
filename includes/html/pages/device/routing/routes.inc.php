...
<div>Warning: Routing Table is only retrieved during device discovery. Devices are skipped if they have more than <?php echo ObzoraConfig::get('routes_max_number'); ?> routes.</div>
<script>
