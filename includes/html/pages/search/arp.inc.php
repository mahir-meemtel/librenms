    ...
    <table id="arp-search" class="table table-hover table-condensed table-striped">
        <thead>
            <tr>
                ...
                <th data-column-id="mac_oui" data-sortable="false" data-visible="<?php echo \App\Facades\ObzoraConfig::get('mac_oui.enabled') ? 'true' : 'false' ?>" data-formatter="tooltip">Vendor</th>
