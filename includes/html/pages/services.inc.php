            ...
            <div class="panel-heading">
                ...
                foreach (dbFetchRows($host_sql, $host_par) as $device) {
                    ...
                    foreach ($services as $service) {
                        ...
                        echo '<td>' . nl2br(\ObzoraNMS\Util\Clean::html($service['service_name'], [])) . '</td>';
                        echo '<td>' . nl2br(\ObzoraNMS\Util\Clean::html($service['service_type'], [])) . '</td>';
                        echo '<td>' . nl2br(\ObzoraNMS\Util\Clean::html($service['service_ip'], [])) . '</td>';
                        echo '<td>' . nl2br(\ObzoraNMS\Util\Clean::html($service['service_message'], [])) . '</td>';
                        echo '<td>' . nl2br(\ObzoraNMS\Util\Clean::html($service['service_desc'], [])) . '</td>';
                        echo '<td>' . \ObzoraNMS\Util\Time::formatInterval(time() - $service['service_changed']) . '</td>';
                        ...
                        $service_name = \ObzoraNMS\Util\Clean::html($service['service_name']);
