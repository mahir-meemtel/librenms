...
if (!Bill::where('bill_id', $bill_id)->exists()) {
    ...
    echo '<div style="font-weight: bold; float: right;"><a href="' . \ObzoraNMS\Util\Url::generate(['page' => 'bills']) . '/"><i class="fa fa-arrow-left fa-lg icon-theme" aria-hidden="true"></i> Back to Bills</a></div>';
