...
<div class="col-xs-12">
    ...
    <div class="panel-heading">
        <ul class="nav nav-tabs">
            ...
            <li><a href="<?php echo \ObzoraNMS\Util\Url::generate(['page' => 'tools', 'tool' => 'oxidized-cfg-check']); ?>">Oxidized config validation</a></li>
        </ul>
    </div>
            ...
            header: '<div id="{{ctx.id}}" class="{{css.header}}"><div class="row">\
                        <div class="col-sm-8 actionBar">\
                            <span class="pull-left">\
                                ...
                                title="Update Oxidized\'s node list from ObzoraNMS data"><i class="fa fa-refresh"></i>\
