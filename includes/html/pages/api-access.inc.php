...
?>
  ...
  <div class="modal fade bs-example-modal-sm" id="create-token" tabindex="-1" role="dialog" aria-labelledby="Create" aria-hidden="true">
   ...
   <div class="modal fade" id="display-qr" tabindex="-1" role="dialog" aria-labelledby="Delete" aria-hidden="true">
    ...
    <?php
    echo '<style>
    /* API Access page content visibility - white background for better readability */
    .api-access-page-content {
    ...
    .api-access-page-content .row {
        background-color: transparent !important;
    }

    .api-access-page-content h3 {
        color: #333 !important;
        margin-top: 0 !important;
        margin-bottom: 15px !important;
    }

    .api-access-page-content hr {
        border-color: #e0e0e0 !important;
    }

    .api-access-page-content table {
        background-color: #ffffff !important;
    }

    .api-access-page-content table td,
    .api-access-page-content table th {
        color: #333 !important;
        background-color: #ffffff !important;
    }

    .api-access-page-content table tr {
        background-color: #ffffff !important;
    }

    .api-access-page-content table.table-hover tbody tr:hover {
        background-color: #f5f5f5 !important;
    }

    .api-access-page-content a {
        color: #2c539e !important;
    }

    .api-access-page-content a:hover {
        color: #1e3a6f !important;
    }

    .api-access-page-content label {
        color: #333 !important;
    }

    .api-access-page-content .alert {
        background-color: #ffffff !important;
        color: #333 !important;
    }
</style>
<div class="api-access-page-content">
  <div class="row">
    <div class="col-md-12">
      <span id="thanks"></span>
    </div>
