...
if ($vars['stream']) {
    $tmp_output .= '"<option value=\"' . \ObzoraNMS\Util\Clean::html($vars['stream'], []) . '\">' . \ObzoraNMS\Util\Clean::html($vars['stream'], []) . '</option>" +';
...
if (\App\Facades\ObzoraConfig::has('graylog.timezone')) {
