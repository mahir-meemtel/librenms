<?php
use ObzoraNMS\Alerting\QueryBuilderFilter;
use App\Facades\ObzoraConfig;

$default_severity = ObzoraConfig::get('alert_rule.severity');
$default_max_alerts = ObzoraConfig::get('alert_rule.max_alerts');
$default_delay = ObzoraConfig::get('alert_rule.delay') . 'm';
$default_interval = ObzoraConfig::get('alert_rule.interval') . 'm';
$default_mute_alerts = ObzoraConfig::get('alert_rule.mute_alerts');
$default_invert_rule_match = ObzoraConfig::get('alert_rule.invert_rule_match');
$default_recovery_alerts = ObzoraConfig::get('alert_rule.recovery_alerts');
$default_acknowledgement_alerts = ObzoraConfig::get('alert_rule.acknowledgement_alerts');
$default_invert_map = ObzoraConfig::get('alert_rule.invert_map');
...
if (Auth::user()->hasGlobalAdmin()) {
    ...
    $(document).ready(function() {
        // Wait for queryBuilder to be available
        ...
        } // end initQueryBuilder
        
        initQueryBuilder(); // Initialize query builder when ready
            ...
            // Prevent Bootstrap modal from interfering with Select2 dropdowns
            $('#create-alert').on('shown.bs.modal', function () {
