...
$default_behavior = MaintenanceBehavior::from((int) ObzoraConfig::get('alert.scheduled_maintenance_default_behavior'));
...
<script>
    $("#maintenance-submit").on("click", function() {
        ...
        var title = '<?=\ObzoraNMS\Util\Clean::html(DeviceCache::get($device['device_id'])->displayName(), []); ?>';
        var notes = $('#notes').val();
        var recurring = 0;
