    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Create">Alert Template :: <a target="_blank" href="https://docs.obzora.meemtel.com/Alerting/Templates/"><i class="fa fa-book fa-1x"></i> Docs</a></h4>
            </div>
    ...
    $.ajax({
        ...
        success: function(output) {
            ...
            if(output['template'].indexOf("{/if}")>=0){
                toastr.info('The old template syntax is no longer supported. Please see https://docs.obzora.meemtel.com/Alerting/Old_Templates/');
