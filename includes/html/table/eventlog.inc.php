 ...
 * @copyright  2018 ObzoraNMS
 * @author     ObzoraNMS Contributors
*/
...
$sql = "SELECT `E`.*,DATE_FORMAT(datetime, '" . \App\Facades\ObzoraConfig::get('dateformat.mysql.compact') . "') as humandate,severity $sql";
