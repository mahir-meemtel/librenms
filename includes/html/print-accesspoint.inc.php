...
echo "<tr style=\"background-color: $row_colour;\" valign=top onmouseover=\"this.style.backgroundColor='" . ObzoraConfig::get('list_colour.highlight') . "';\" onmouseout=\"this.style.backgroundColor='$row_colour';\" onclick=\"location.href='" . generate_ap_url($ap) . "/'\" style='cursor: pointer;'>
...
echo generate_ap_link($ap, "<img src='graph.php?type=$ap[graph_type]&amp;id=" . $ap['accesspoint_id'] . '&amp;from=' . ObzoraConfig::get('time.day') . '&amp;to=' . ObzoraConfig::get('time.now') . '&amp;width=100&amp;height=20&amp;legend=no&amp;bg=' . str_replace('#', '', $row_colour) . "'>");
echo "<br>\n";
...
echo "<i class='fa fa-wifi fa-lg icon-theme' aria-hidden='true'></i> " . \ObzoraNMS\Util\Number::formatBi($ap['numasoclients'], 2, 0, '') . ' Clients<br />';
echo "<i class='fa fa-wifi fa-lg icon-theme' aria-hidden='true'></i> " . \ObzoraNMS\Util\Number::formatBi($ap['radioutil'], 2, 0, '') . ' % busy<br />';
echo "<i class='fa fa-wifi fa-lg icon-theme' aria-hidden='true'></i> " . \ObzoraNMS\Util\Number::formatBi($ap['interference'], 2, 0, '') . ' interference index<br />';
