...
$descr = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr(short_hrDeviceDescr($components['name']), $descr_len);

$perc = \ObzoraNMS\Util\Number::calculatePercent((int) $components['memory_used'], (int) $tmp_component['memory_total']);

$background = \ObzoraNMS\Util\Color::percentage($perc, 75);
