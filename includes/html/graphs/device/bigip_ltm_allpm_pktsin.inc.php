...
$colours = array_merge(\App\Facades\ObzoraConfig::get('graph_colours.mixed'), \App\Facades\ObzoraConfig::get('graph_colours.manycolours'), \App\Facades\ObzoraConfig::get('graph_colours.manycolours'));
$count = 0;
d_echo('<pre>');
