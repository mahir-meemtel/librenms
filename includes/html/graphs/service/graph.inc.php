...
$check_script = \App\Facades\ObzoraConfig::get('install_dir') . '/includes/services/check_' . strtolower($services[$vars['service']]['service_type']) . '.inc.php';
...
if ($services[$vars['service']]['service_ds'] != '') {
    ...
    if (Rrd::checkRrdExists($rrd_filename)) {
        if (isset($check_graph)) {
            ...
            $color_avg = \App\Facades\ObzoraConfig::get("graph_colours.$tint.2");
            $color_max = \App\Facades\ObzoraConfig::get("graph_colours.$tint.0");
