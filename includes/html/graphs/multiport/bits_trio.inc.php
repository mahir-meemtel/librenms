...
$rrd_options .= \App\Facades\ObzoraConfig::get('rrdgraph_def_text') . ' -c FONT#' . ltrim(\App\Facades\ObzoraConfig::get('rrdgraph_def_text_color'), '#');
...
if ($width <= '300') {
    $rrd_options .= ' --font LEGEND:7:' . \App\Facades\ObzoraConfig::get('mono_font') . ' --font AXIS:6:' . \App\Facades\ObzoraConfig::get('mono_font') . ' --font-render-mode normal';
}
