...
$descr = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr($storage['storage_descr'], 16);

$percentage = round($storage['storage_perc'], 0);

$background = \ObzoraNMS\Util\Color::percentage($percentage, $storage['storage_perc_warn']);
...
if ($previous) {
    $descr = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('Prev ' . $storage['storage_descr'], 16);
