...
$scale_min = '0';
$colors = ObzoraConfig::get('graph_colours.manycolours');

require 'includes/html/graphs/common.inc.php';

$hostnames = Device::pluck('hostname');
$modules = array_keys(ObzoraConfig::get('poller_modules'));
sort($modules);
...
foreach ($modules as $index => $module) {
    ...
    $rrd_options .= " AREA:$module#$color:'" . \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr($module, 16) . "':STACK";
