...
if (! isset($colour25th)) {
    ...
    $colour25th = \App\Facades\ObzoraConfig::get("graph_colours.$colours.$iter");
    $iter++;
}
...
if (! isset($colour50th)) {
    ...
    $colour50th = \App\Facades\ObzoraConfig::get("graph_colours.$colours.$iter");
    $iter++;
}
...
if (! isset($colour75th)) {
    ...
    $colour75th = \App\Facades\ObzoraConfig::get("graph_colours.$colours.$iter");
    $iter++;
}
...
if (! isset($colour1h)) {
    ...
    $colour1h = \App\Facades\ObzoraConfig::get("graph_colours.$colours.$iter");
    $iter++;
}
...
if (! isset($colour1d)) {
    ...
    $colour1d = \App\Facades\ObzoraConfig::get("graph_colours.$colours.$iter");
    $iter++;
}
...
if (! isset($colour1w)) {
    ...
    $colour1w = \App\Facades\ObzoraConfig::get("graph_colours.$colours.$iter");
    $iter++;
}

$graph_stat_percentile_disable = \App\Facades\ObzoraConfig::get('graph_stat_percentile_disable');

$descr = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr($descr, $descr_len);

if ($height > 25) {
    if (! $no_hourly) {
        $descr_1h = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('1 hour avg', $descr_len);
        $descr_1h_min = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('1 hour min', $descr_len);
        $descr_1h_max = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('1 hour max', $descr_len);
    }
    if (! $no_daily) {
        $descr_1d = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('1 day avg', $descr_len);
        $descr_1d_min = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('1 day min', $descr_len);
        $descr_1d_max = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('1 day max', $descr_len);
    }
    if (! $no_weekly) {
        $descr_1w = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('1 week avg', $descr_len);
        $descr_1w_min = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('1 week min', $descr_len);
        $descr_1w_max = \ObzoraNMS\Data\Store\Rrd::fixedSafeDescr('1 week max', $descr_len);
    }
}
