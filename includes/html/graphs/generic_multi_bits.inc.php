...
if ($i) {
    ...
    $rrd_options .= ' VDEF:dpercentile_outnp=dpercentile_outn,' . \App\Facades\ObzoraConfig::get('percentile_value') . ',PERCENT';
    ...
    if ($graph_params->visible('previous')) {
        ...
        $rrd_options .= ' VDEF:percentile_inX=inbitsX,' . \App\Facades\ObzoraConfig::get('percentile_value') . ',PERCENT';
        $rrd_options .= ' VDEF:percentile_outX=outbitsX,' . \App\Facades\ObzoraConfig::get('percentile_value') . ',PERCENT';
        $rrd_options .= ' CDEF:dpercentile_outXn=doutbitsX,' . $stacked['stacked'] . ',*';
        $rrd_options .= ' VDEF:dpercentile_outX=dpercentile_outXn,' . \App\Facades\ObzoraConfig::get('percentile_value') . ',PERCENT';
    ...
    if ($legend == 'no' || $legend == '1') {
        ...
        $rrd_options .= ' AREA:inbits#' . $colour_area_in . $stacked['transparency'] . ':';
        $rrd_options .= " COMMENT:'bps      Now       Ave      Max      " . \App\Facades\ObzoraConfig::get('percentile_value') . "th %\\n'";
