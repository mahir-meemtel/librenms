...
{{-- Overview --}}
                <li class="dropdown">
                <a href="{{ url('overview') }}" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">
                    <i class="fa fa-dashboard fa-fw fa-lg fa-nav-icons" aria-hidden="true"></i>
                    <span>{{ __('Overview') }}</span>
                </a>

                    <ul class="dropdown-menu multi-level" role="menu">
                        <li class="dropdown-submenu">
                            <a href="{{ route('overview') }}"><i class="fa fa-columns fa-fw fa-lg fa-nav-icons" aria-hidden="true"></i> {{ __('Dashboard') }}</a>
                        ...
                        <li class="dropdown-submenu">
                            <a><i class="fa fa-puzzle-piece fa-fw fa-lg" aria-hidden="true"></i> {{ __('Plugins') }}</a>
                        ...
                        @endif
                        <li class="dropdown-submenu">
                            <a><i class="fa fa-toolbox fa-fw fa-lg"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{ \App\Facades\ObzoraConfig::get('smokeping.url') }}"><i class="fa fa-line-chart fa-fw fa-lg"
                        ...
                        <li role="presentation" class="divider"></li>
                        <li><a href="{{ url('eventlog') }}"><i class="fa fa-file fa-fw fa-lg"
                        ...
                        <li><a href="{{ route('inventory') }}"><i class="fa fa-box fa-fw fa-lg"
                        ...
                        <li role="presentation" class="divider"></li>
                        <li><a href="{{ url('search/search=ipv4') }}"><i class="fa fa-network-wired fa-fw fa-lg"
                                                                         aria-hidden="true"></i> {{ __('IPv4 Address') }}
                            </a></li>
                        <li><a href="{{ url('search/search=ipv6') }}"><i class="fa fa-globe fa-fw fa-lg"
                                                                         aria-hidden="true"></i> {{ __('IPv6 Address') }}
                            </a></li>
                        <li><a href="{{ url('search/search=mac') }}"><i class="fa fa-id-badge fa-fw fa-lg"
                                                                        aria-hidden="true"></i> {{ __('MAC Address') }}</a>
                        </li>
                        <li><a href="{{ url('search/search=arp') }}"><i class="fa fa-exchange-alt fa-fw fa-lg"
                                                                        aria-hidden="true"></i> {{ __('ARP Tables') }}</a>
                        </li>
                        <li><a href="{{ url('search/search=fdb') }}"><i class="fa fa-th-list fa-fw fa-lg"
...
{{-- Devices --}}
                <li class="dropdown">
                    <a href="{{ url('devices/') }}" class="dropdown-toggle" data-hover="dropdown"
                       data-toggle="dropdown"><i class="fa-solid fa-network-wired fa-fw fa-lg fa-nav-icons"
                                                 aria-hidden="true"></i> <span>{{ __('Devices') }}</span></a>
                    <ul class="dropdown-menu">
                    @if($no_devices_added)
                    <li><a href="#"><i class="fa fa-ban fa-fw fa-lg" aria-hidden="true"></i> {{ __('No Devices') }}</a>
                    @else
                    <li @class(['dropdown-submenu' => $device_types->isNotEmpty()])><a href="{{ url('devices') }}"><i class="fa fa-desktop fa-fw fa-lg" aria-hidden="true"></i> {{ __('All Devices') }}</a>
                    ...
                    @if($device_groups->isNotEmpty())
                            <li class="dropdown-submenu"><a><i class="fa fa-server fa-fw fa-lg"
                    ...
                    @admin
                        ...
                        @can('manage', \App\Models\DeviceGroup::class)
                            <li><a href="{{ url('device-groups') }}"><i class="fa fa-users fa-fw fa-lg"
                                                                        aria-hidden="true"></i> {{ __('Manage Groups') }}
                                </a></li>
                        @endcan
                        <li><a href="{{ url('device-dependencies') }}"><i class="fa fa-sitemap fa-fw fa-lg"></i> {{ __('Device Dependencies') }}</a></li>
                        @if($show_vmwinfo)
                            <li><a href="{{ url('vminfo') }}"><i
                                        class="fa fa-desktop fa-fw fa-lg"></i> {{ __('Virtual Machines') }}</a></li>
                        @endif
                        <li role="presentation" class="divider"></li>
                        <li><a href="{{ url('addhost') }}"><i class="fa fa-plus-square fa-fw fa-lg"
                                                              aria-hidden="true"></i> {{ __('Add Device') }}</a></li>
                        <li><a href="{{ url('delhost') }}"><i class="fa fa-minus-square fa-fw fa-lg"
...
{{-- Maps --}}
                <li class="dropdown">
                    <a href="{{ url('services') }}" class="dropdown-toggle" data-hover="dropdown"
                       data-toggle="dropdown"><i class="fa fa-globe fa-fw fa-lg fa-nav-icons"
                                                 aria-hidden="true"></i> <span
                            class="tw:md:hidden tw:lg:inline-block">{{ __('Maps') }}</span></a>
                    <ul class="dropdown-menu">
                        <li><a href="{{ url('availability-map') }}"><i class="fa fa-check-circle fa-fw fa-lg"
                        ...
                        <li><a href="{{ route('maps.custom.index') }}">
                            <i class="fa fa-map-signs fa-fw fa-lg" aria-hidden="true"></i> {{ __('Custom Map Editor') }}
                        </a></li>
...
{{-- Ports --}}
                <li class="dropdown">
                    <a href="{{ url('ports') }}" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><i
                            class="fa fa-exchange fa-fw fa-lg fa-nav-icons" aria-hidden="true"></i> <span
                            class="tw:md:hidden tw:lg:inline-block">{{ __('Ports') }}</span></a>
                    <ul class="dropdown-menu">
                        <li><a href="{{ url('ports') }}"><i class="fa fa-code-fork fa-fw fa-lg fa-nav-icons"
                        ...
                        <li><a href="{{ route('vlans.index') }}"><i class="fa fa-network-wired fa-fw fa-lg"
                        ...
                        @if(auth()->user()->hasGlobalRead())
                            @if($port_groups_exist)
                                ...
                                @endconfig
                                @config('int_transit')
                                <li><a href="{{ url('iftype/type=transit') }}"><i class="fa fa-arrows-alt-h fa-fw fa-lg"
                                                                                  aria-hidden="true"></i> {{ __('Transit') }}
                                    </a></li>
                                @endconfig
                                @config('int_peering')
                                <li><a href="{{ url('iftype/type=peering') }}"><i class="fa fa-sitemap fa-fw fa-lg"
                                                                                  aria-hidden="true"></i> {{ __('Peering') }}
                                    </a></li>
                                @endconfig
                                @if(\App\Facades\ObzoraConfig::get('int_peering') && \App\Facades\ObzoraConfig::get('int_transit'))
                                    <li><a href="{{ url('iftype/type=peering,transit') }}"><i
                                                class="fa fa-project-diagram fa-fw fa-lg"
                                                aria-hidden="true"></i> {{ __('Peering + Transit') }}</a></li>
                                @endif
                                @config('int_core')
                                <li><a href="{{ url('iftype/type=core') }}"><i class="fa fa-layer-group fa-fw fa-lg"
...
{{-- Sensors --}}
                <li class="dropdown">
                    <a href="{{ url('health') }}" class="dropdown-toggle" data-hover="dropdown"
                       data-toggle="dropdown"><i class="fa fa-medkit fa-fw fa-lg fa-nav-icons"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ url('health/metric=processor') }}"><i class="fa fa-microchip fa-fw fa-lg fa-nav-icons"
                                                                              aria-hidden="true"></i> {{ __('Processor') }}
                            </a></li>
                        <li><a href="{{ url('health/metric=storage') }}"><i class="fa fa-hdd fa-fw fa-lg"
...
{{-- Alerts --}}
                ...
                <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">
                    <i class="fa fa-bell text-{{ $alert_menu_class }} fa-fw fa-lg" aria-hidden="true"></i>
                    <span>{{ __('Alerts') }}</span>
                </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ url('alert-log') }}"><i class="fa fa-history fa-fw fa-lg"
                        ...
                        @admin
                        <li role="presentation" class="divider"></li>
                        <li><a href="{{ url('alert-rules') }}"><i class="fa fa-shield fa-fw fa-lg"
                        ...
                        <li><a href="{{ url('templates') }}"><i class="fa fa-file-text fa-fw fa-lg"
                                                                aria-hidden="true"></i> {{ __('Alert Templates') }}</a>
                        </li>
                        <li><a href="{{ url('alert-transports') }}"><i class="fa fa-paper-plane fa-fw fa-lg"
...
{{-- User --}}
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">
                        <i class="fa fa-user-tie fa-fw fa-lg" aria-hidden="true"></i>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ route('preferences.index') }}"><i class="fa fa-wrench fa-fw fa-lg"
                                                                  aria-hidden="true"></i> {{ __('My Settings') }}</a></li>
                        {{-- <li><x-theme-toggle /></li> --}}
                        <li>
                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <i class="fa fa-power-off fa-fw fa-lg" aria-hidden="true"></i> {{ __('Logout') }}
                            </a>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"
                       style="margin-left:5px"><i class="fa fa-sliders-h fa-fw fa-lg" aria-hidden="true"></i>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li role="presentation" class="divider"></li>
                        <li><a href="{{ route('users.index') }}"><i class="fa fa-users fa-fw fa-lg"
                                                                    aria-hidden="true"></i> {{ __('Manage Users') }}</a>
                        </li>
                        <li><a href="{{ url('authlog') }}"><i class="fa fa-history fa-fw fa-lg"
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="https://docs.obzora.meemtel.com/API/" target="_blank" rel="noopener"><i
                        ...
                        <li><a href="{{ url('about') }}"><i class="fa fa-question-circle fa-fw fa-lg"
...
<footer class="app-footer">
    Powered by <span class="copyright-symbol">©</span><strong>Obzora NMS</strong>
</footer>
