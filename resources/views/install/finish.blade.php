        ...
        <div class="card-body">
            <form id="settings">
                ...
                <div class="custom-control custom-checkbox mb-3">
                    ...
                    <label class="custom-control-label" for="usage_reporting"><a target="_blank" href="https://stats.obzora.meemtel.com/">{{ __('settings.settings.reporting.usage.description') }}</a></label>
                </div>
