...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scan network for snmp hosts and add them to ObzoraNMS.",
...
Example: 192.168.0.1/32 will be treated as a single host address""",
    ...
    if not CONFIG.get("nets", []) and not netargs:
        parser.error(
            "'nets' is not set in your ObzoraNMS config, you must specify a network to scan"
        )
