    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Users will be deleted from ObzoraNMS after this many days of not logging in. 0 means never and users will be recreated if the user logs back in.',
            ],
        ],
        ...
        'collectd_dir' => [
            ...
            'help' => 'Directory where collectd stores its RRD files.  This is used to display data from collectd into ObzoraNMS.',
        ],
        'collectd_sock' => [
            'description' => 'Collectd Socket',
            'help' => 'Socket collectd is listening on.  This is used to display data from collectd into ObzoraNMS.',
        ],
        'core_descr' => [
        ...
        'distributed_poller' => [
            ...
            'help' => 'Enable distributed polling system wide. This is intended for load sharing, not remote polling. You must read the documentation for steps to enable: https://docs.obzora.meemtel.com/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'This domain is used for network auto-discovery and other processes. ObzoraNMS will attempt to append it to unqualified hostnames.',
        ],
        ...
        'own_hostname' => [
            'description' => 'ObzoraNMS hostname',
            'help' => 'Should be set to the hostname/ip the obzora server is added as',
        ],
        'oxidized' => [
            'default_group' => [
            ...
            'ignore_os' => [
                ...
                'help' => 'Do not backup the listed OS with Oxidized.  The OS must match the ObzoraNMS OS name (these are all lowercase with no spaces).  Only allows existing OS.',
            ],
            'ignore_types' => [
        ...
        'autodiscovery' => [
            ...
            'xdp' => [
                ...
                'help' => 'Use LLDP, CDP, etc protocols to discover network topology and neighbors and add them to ObzoraNMS',
            ],
            'xdp_exclude' => [
                'sysname_regexp' => [
        ...
        'reporting' => [
            'error' => [
                ...
                'help' => 'Sends some errors to ObzoraNMS for analysis and fixing',
            ],
            'usage' => [
                'description' => 'Send Usage Reports',
                'help' => 'Reports usage and versions to ObzoraNMS. To delete anonymous stats, visit the about page. You can view stats at https://stats.obzora.meemtel.com',
            ],
            'dump_errors' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Location of rrd files.  Default is rrd inside the ObzoraNMS directory.  Changing this setting does not move the rrd files.',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => 'Anything over 1.5.5 supports all features ObzoraNMS uses, do not set higher than your installed version',
        ],
        'schedule_type' => [
            'alerting' => [
        ...
        'sensors' => [
            'guess_limits' => [
                ...
                'help' => 'If enabled, ObzoraNMS will try to guess the sensor limits based on the sensor type and value. This is not always accurate and may lead to incorrect limits.',
            ],
        ],
        ...
        'service_watchdog_log' => [
            ...
            'help' => 'Default is the ObzoraNMS log file. Sets the default value for all nodes.',
        ],
        'service_health_file' => [
