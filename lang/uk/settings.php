    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Користувачі будуть видалені з ObzoraNMS після визначеної кількості днів без входу. 0 означає ніколи. Користувачі будуть створені повторно при вході.',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'Увімкнути  розподілене опитування для всієї системи. Призначено для розподілу навантаження, не віддаленого опитування. Необхідно ознайомитися з документацією для налаштування: https://docs.obzora.meemtel.com/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'Цей домен буде використаний для автовіднайдення пристроїв у мережі та інших процесів. ObzoraNMS спробує додавати його до некваліфікованих імен хостів.',
        ],
        ...
        'own_hostname' => [
            'description' => 'Ім\'я хоста сервера ObzoraNMS',
            'help' => 'Має бути іменем хоста/IP адресою сервера ObzoraNMS',
        ],
        'oxidized' => [
            'default_group' => [
            ...
            'ignore_os' => [
                ...
                'help' => 'Ну здійснювати резервних копій вказаних OS за допомогою Oxidized. OS мусить співпадати з назвою OS у ObzoraNMS (у нижньому регістрі без пробілів).  Лише OS з існуючими визначеннями.',
            ],
            'ignore_types' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Місцезнаходження файлів RRD. За замовчуванням вони знаходяться усередині директорії ObzoraNMS. Зміна цього налаштування не переміщує файли.',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => 'Версії вищі за 1.5.5 підтримують всі функції що використовує ObzoraNMS, не встановлюйте значення вищі за наявну версію',
        ],
        ...
        'service_watchdog_log' => [
            ...
            'help' => 'За замовчуванням лог файл ObzoraNMS. Визначає значення за замовчуванням для всіх вузлів.',
        ],
        'sfdp' => [
