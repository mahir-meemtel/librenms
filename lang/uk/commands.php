...
return [
    ...
    'dev:check' => [
        'description' => 'Перевірки коду ObzoraNMS. Запуск без опцій запускає всі перевірки',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Ім\'я файлу snmprec який необхідно оновити або додати до ObzoraNMS. Якщо файл не вказано, пристрій не буде додано або оновлено.',
        ],
        'options' => [
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Для додаткової інформації див. https://docs.obzora.meemtel.com/Extensions/Smokeping/"',
