...
return [
    ...
    'dev:check' => [
        'description' => 'Проверки кода ObzoraNMS. Запуск без опций выполняет все проверки',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Имя файла (только базовое имя) файла snmprec для обновления или добавления в ObzoraNMS. Если файл не указан, устройство не будет добавлено или обновлено.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'Если у вас нет старого ключа, вы должны удалить все зашифрованные данные, чтобы продолжить использовать определенные функции ObzoraNMS',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Для получения дополнительной информации смотрите https://docs.obzora.meemtel.com/Extensions/Smokeping/"',
