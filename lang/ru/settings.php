    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Пользователи будут удалены из ObzoraNMS после этого количества дней без входа. 0 означает никогда, и пользователи будут восстановлены, если они снова войдут в систему.',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'Включает распределенную систему опроса по всей системе. Это предназначено для распределения нагрузки, а не для удаленного опроса. Вам необходимо прочитать документацию для получения шагов по включению: https://docs.obzora.meemtel.com/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'Этот домен используется для автоматического обнаружения сети и других процессов. ObzoraNMS попытается добавить его к неквалифицированным именам хостов.',
        ],
        ...
        'own_hostname' => [
            'description' => 'Имя хоста ObzoraNMS',
            'help' => 'Должно быть установлено на имя хоста/IP, под которым сервер obzora добавлен',
        ],
        'oxidized' => [
            'default_group' => [
            ...
            'ignore_os' => [
                ...
                'help' => 'Не делать резервные копии указанных ОС с помощью Oxidized. ОС должны соответствовать названию ОС ObzoraNMS (все строчные буквы без пробелов). Разрешены только существующие ОС.',
            ],
            'ignore_types' => [
        ...
        'reporting' => [
            'error' => [
                ...
                'help' => 'Отправляет некоторые ошибки в ObzoraNMS для анализа и исправления',
            ],
            'usage' => [
                'description' => 'Отправить отчеты об использовании',
                'help' => 'Отправляет отчеты о использовании и версиях в ObzoraNMS. Чтобы удалить анонимную статистику, посетите страницу "О программе". Вы можете просмотреть статистику на https://stats.obzora.meemtel.com',
            ],
            'dump_errors' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Местоположение файлов rrd. По умолчанию это rrd в директории ObzoraNMS. Изменение этой настройки не переместит файлы rrd.',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => 'Все версии выше 1.5.5 поддерживают все функции, используемые ObzoraNMS, не устанавливайте выше вашей установленной версии',
        ],
        'schedule_type' => [
            'alerting' => [
        ...
        'service_watchdog_log' => [
            ...
            'help' => 'По умолчанию это файл журнала ObzoraNMS. Устанавливает значение по умолчанию для всех узлов.',
        ],
        'sfdp' => [
