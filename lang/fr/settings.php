    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Les utilisateurs seront effacés de ObzoraNMS après ce nombre de jour(s) sans connexion. 0 signifie `jamais`. Les utilisteurs seront créés à nouveau quand ils se reconnecteront.',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'Cf documentation : https://docs.obzora.meemtel.com/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'Ce domaine est utilisé pour la découverte automatique de réseau et d\'autres processus. ObzoraNMS essaie de le concatener aux noms incomplets.',
        ],
        'nfdump' => [
        ...
        'own_hostname' => [
            'description' => 'Nom d\'hôte ObzoraNMS',
            'help' => 'Doit être configuré avec le nom d\'hôte/IP du serveur ObzoraNMS.',
        ],
        'oxidized' => [
            'default_group' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Emplacement des fichiers rrd.  Défaut: fichiers rrd dans le répertoire de ObzoraNMS. La modification de cette valeur ne déplace pas les fichiers RRD.',
        ],
        'rrd_purge' => [
        ...
        'title_image' => [
            ...
            'help' => 'Remplace le logo ObzoraNMS sur la page d\'accueil/authentification',
        ],
        'traceroute' => [
