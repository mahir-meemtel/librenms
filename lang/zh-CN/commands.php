...
return [
    ...
    'dev:check' => [
        'description' => 'ObzoraNMS代码检查。不带选项运行时运行所有检查',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => '要更新或添加到ObzoraNMS的snmprec文件的基本文件名。如果没有指定文件，则不会添加或更新设备。',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => '如果您没有旧密钥，您必须删除所有加密数据才能继续使用ObzoraNMS的某些功能',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => '更多信息请参见 https://docs.obzora.meemtel.com/Extensions/Smokeping/"',
