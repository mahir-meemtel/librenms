    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => '设定使用者超过几天没有登入后，将会被 ObzoraNMS 自动删除。设为 0 表示不会删除，若使用者重新登入，将会重新建立账户。',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => '启用全系统分布式轮询功能。此功能旨在实现负载分担，而非远程轮询。您必须阅读以下文档以获取启用步骤：https://docs.obzora.meemtel.com/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            'description' => '主要网域',
            'help' => '此域名用于网络自动发现和其他进程。ObzoraNMS将尝试将其附加到未完全限定的主机名上。',
        ],
        'nfsen_enable' => [
        ...
        'own_hostname' => [
            'description' => 'ObzoraNMS 主机名称',
            'help' => '应设置为obzora服务器添加时使用的主机名/IP地址',
        ],
        'oxidized' => [
            'default_group' => [
        ...
        'rrd_dir' => [
            'description' => 'RRD 位置',
            'help' => 'RRD 文件的存储位置。默认位置是 ObzoraNMS 目录内的 rrd 文件夹。更改此设置不会移动现有的 RRD 文件。',
        ],
        'rrd_purge' => [
