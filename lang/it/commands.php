...
return [
    ...
    'dev:check' => [
        'description' => 'ObzoraNMS code checks. Running with no options runs all checks',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'The file name (only base name) of the snmprec file to update or add to ObzoraNMS. If file not specified, no device will be added or updated.',
        ],
        'options' => [
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'For more information see https://docs.obzora.meemtel.com/Extensions/Smokeping/"',
