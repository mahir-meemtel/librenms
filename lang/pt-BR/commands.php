...
return [
    ...
    'dev:check' => [
        'description' => 'Verificações de código do ObzoraNMS. Executar sem opções executa todas as verificações',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'O nome do arquivo (apenas o nome base) do arquivo snmprec para atualizar ou adicionar ao ObzoraNMS. Se o arquivo não for especificado, nenhum dispositivo será adicionado ou atualizado.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'Se você não tiver a chave antiga, deve excluir todos os dados criptografados para poder continuar a usar certos recursos do ObzoraNMS',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Para mais informações, veja https://docs.obzora.meemtel.com/Extensions/Smokeping/"',
