    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Usuários serão deletados do ObzoraNMS após esse período de tempo sem fazer login. 0 significa nunca e os usuários serão recriados se o usuário fizer login novamente.',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'Habilitar coleta de dados distribuída em todo o sistema. Isso é destinado ao compartilhamento de carga, não à coleta remota. Leia a documentação para verificar as etapas de habilitação: https://docs.obzora.meemtel.com/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'Este domínio é usado para descoberta automática de rede e outros processos. O ObzoraNMS tentará anexá-lo a nomes de host não qualificados.',
        ],
        ...
        'own_hostname' => [
            'description' => 'Nome de host do ObzoraNMS',
            'help' => 'Deve ser definido como o nome do host/ip ao qual o servidor obzora é adicionado',
        ],
        'oxidized' => [
            'default_group' => [
            ...
            'ignore_os' => [
                ...
                'help' => 'Não fazer backup dos sistemas operacionais listados com o Oxidized. Deve corresponder ao nome do Sistema Operacional no ObzoraNMS (todos em minúsculas e sem espaços). Permite apenas sistemas operacionais existentes.',
            ],
            'ignore_types' => [
        ...
        'reporting' => [
            'error' => [
                ...
                'help' => 'Envia determinados erros para o ObzoraNMS para análise e correção',
            ],
            'usage' => [
                'description' => 'Enviar Relatórios de Uso',
                'help' => 'Envia relatório de uso e versão para o ObzoraNMS. Para excluir estatísticas anônimas, visite a página Sobre. Você pode visualizar estatísticas em https://stats.obzora.meemtel.com',
            ],
            'dump_errors' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Localização dos arquivos rrd. O padrão é rrd dentro do diretório ObzoraNMS. Alterar essa configuração não move os arquivos rrd.',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => 'Qualquer coisa acima de 1.5.5 suporta todos os recursos que o ObzoraNMS usa, não defina um valor maior do que a versão instalada',
        ],
        'schedule_type' => [
            'alerting' => [
                'description' => 'Alertar',
        ...
        'service_watchdog_log' => [
            ...
            'help' => 'O padrão é o arquivo de log do ObzoraNMS. Valor padrão para todos os nós.',
        ],
        'sfdp' => [
