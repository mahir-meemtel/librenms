    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Benutzer werden von ObzoraNMS gelöscht nach diesen Tagen Inaktivität. 0 bedeutet nie und der Benutzer wird neu erstellt wenn er sich erneut anmeldet',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'Aktiviere systemweites Distributed Polling. Dies wird genutzt für Lastverteilung und nicht remote Polling. Lesen Sie hierzu folgende Dokumentation: https://docs.obzora.meemtel.com/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'Diese Domain wird genutzt für Netzwerkautoerkennung und andere Prozesse. ObzoraNMS wird versuchen diese Hostnamen hinzuzufügen.',
        ],
        'nfsen_enable' => [
        ...
        'own_hostname' => [
            ...
            'help' => 'Sollte auf den hostname/ip des ObzoraNMS Servers gesetzt werden',
        ],
        'oxidized' => [
            'default_group' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Verzeichnis für RRD Dateien. Standardmässig ist RRD innerhalb des ObzoraNMS Verzeichnisses. Eine Änderung verschiebt nicht die vorhandenen RRD Dateien.',
        ],
        'rrd_purge' => [
