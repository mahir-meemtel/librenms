...
return [
    ...
    'dev:check' => [
        'description' => 'ObzoraNMS-ის კოდის შემოწმებები. პარამეტრების გარეშე გაშვება ყველა შემოწმებას გაუშვებს',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'snmprec ფაილის სახელი (მხოლოდ სახელი) განახლებისთვის, ან ObzoraNMS-ში დასამატებლად. თუ ფაილი მითითებული არაა, მოწყობილობები არც დაემატება, არც განახლდება.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'თუ თქვენ არ გაქვთ ძველი გასაღები, ყველა დაშიფრული მონაცემები უნდა წაშალოთ, რომ ObzoraNMS-ის ზოგიერთი ფუნქცია გამოიყენოთ',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'მეტი ინფორმაციისთვის იხილეთ https://docs.obzora.meemtel.com/Extensions/Smokeping/"',
