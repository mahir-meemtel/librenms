    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'მომხმარებლები წაიშლება ObzoraNMS-დან ამდენი დღის შემდეგ შესვლის გარეშე. 0 ნიშნავს არასდროს და მომხმარებლები აღდგება, თუ ისინი კვლავ შევლენ სისტემაში.',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'განაწილებული გამოთხოვის ჩართვა მთელ სისტემაში. ეს განკუთვნილია დატვირთვის გაზიარებისთვის და არა დაშორებული გამოთხოვისთვის. დოკუმენტაცია ნაბიჯებისთვის, რომ ჩართოთ ის: https://docs.obzora.meemtel.com/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'ეს დომენი გამოიყენება ქსელური ავტოაღმოჩენისთვის და სხვა პროცესებისთვის. ObzoraNMS სცდის, დაუსრულებელ ჰოსტის სახელებს ეს მიაწეროს.',
        ],
        ...
        'own_hostname' => [
            'description' => 'ObzoraNMS-ის ჰოსტის სახელი',
            'help' => 'უნდა დააყენოთ ჰოსტის სახელზე/IP მისამართზე, რომელზეც დამატებულია ObzoraNMS სერვერი',
        ],
        'oxidized' => [
            'default_group' => [
            ...
            'ignore_os' => [
                ...
                'help' => 'არ მოხდება ჩამოთვლილი ოს-ების მარქაფი Oxidized-თ. ოს უნდა ემთხვეოდეს ObzoraNMS-ის ოს-ის სახელს (ეს ყველა პატარა ასოებით, ჰარეების გარეშე).  მხოლოდ დაუშვებს არსებულ ოს-ს.',
            ],
            'ignore_types' => [
        ...
        'autodiscovery' => [
            ...
            'xdp' => [
                ...
                'help' => 'LLDP, CDP და სხვა პროტოკოლების გამოყენება ქსელის ტოპოლოგიის და მეზობლების აღმოსაჩენად და მათი ObzoraNMS-ში დასამატებლად',
            ],
            'xdp_exclude' => [
                'sysname_regexp' => [
        ...
        'reporting' => [
            'error' => [
                ...
                'help' => 'ზოგიერთი შეცდომის გაგზავნა ObzoraNMS-სთვის ანალიზისა და გასწორებისთვის',
            ],
            'usage' => [
                'description' => 'გამოყენების ანგარიშების გაგზავნა',
                'help' => 'გამოყენების და ვერსიების გაგზავნა ObzoraNMS-სთვის. ანონიმური სტატისტიკის წასაშლელად ეწვიეთ გვერდს "შესახებ". სტატისტიკის ნახვა შეგიძლიათ მისამართზე https://stats.obzora.meemtel.com',
            ],
            'dump_errors' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'rrd ფაილების მდებარეობა.  ნაგულისხმევია rrd ObzoraNMS-ის საქაღალდის შიგნით. ამ პარამეტრის ცვლილება rrd ფაილებს არ გადაიტანს.',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => 'ყველაფერს, რაც 1.5.5-ზე ახალია, აქვს ყველა ის ფუნქცია, რასაც ObzoraNMS იყენებთ, ნუ დააყენებთ სისტემაში არსებულ ვერსიაზე უფრო მაღალზე',
        ],
        'schedule_type' => [
            'alerting' => [
        ...
        'service_watchdog_log' => [
            ...
            'help' => 'ნაგულისხმევი მნიშვნელობაა ObzoraNMS-ის ჟურნალის ფაილი. აყენებს ნაგულისხმევ მნიშვნელობას ყველა კვანძისთვის.',
        ],
        'service_health_file' => [
