...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="ObzoraNMS Service - manages polling and other periodic processes"
    )
    parser.add_argument(
        "-g",
        "--group",
    ...
    info("Configuring ObzoraNMS service")
    try:
        service = ObzoraNMS.Service()
    ...
    info(
        "Entering main ObzoraNMS service loop on {}/{}...".format(
