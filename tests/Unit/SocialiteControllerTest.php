...
class SocialiteControllerTest extends TestCase
{
    ...
    private function runSetRolesFromClaimTest(
        ...
        \App\Facades\ObzoraConfig::set('auth.socialite.scopes', $scopes);
        \App\Facades\ObzoraConfig::set('auth.socialite.claims', $claimMap);
        \App\Facades\ObzoraConfig::set('auth.socialite.debug', false);
    ...
    public function testSetRolesFromClaimSaml2Admin(): void
    {
        ...
        $result = $this->runSetRolesFromClaimTest(
            ...
            ['admin'],
            [
                'G_obzora_admins' => ['roles' => ['admin']],
                'G_obzora_users' => ['roles' => ['global-read']],
            ]
        );
        $this->assertTrue($result);
    }
