    ...
    public function testGetMultilineVariables(): void
    {
        ...
        LaravelHttp::assertSent(function (Request $request) {
            return $request->method() == 'GET' &&
                $request->url() == 'https://obzora.meemtel.com?text=This%20is%20a%20multi-line%0Aalert.';
        });
    }
    ...
    public function testPostMultilineVariables(): void
    {
        ...
        LaravelHttp::assertSent(function (Request $request) {
            return $request->method() == 'POST' &&
                $request->url() == 'https://obzora.meemtel.com?text=This%20is%20a%20post%20multi-line%0Aalert.' &&
