<?php
namespace ObzoraNMS\Tests\Browser;
...
use ObzoraNMS\Tests\Browser\Pages\DashboardPage;
use ObzoraNMS\Tests\Browser\Pages\LoginPage;
use ObzoraNMS\Tests\Browser\Pages\TwoFactorPage;
use ObzoraNMS\Tests\DuskTestCase;
...
//    }
    ...
    public function test2faLogin(): void
    {
        $this->browse(function (Browser $browser) {
            ...
            ObzoraConfig::persist('twofactor', true); // set to db
