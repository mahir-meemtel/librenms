#! /usr/bin/env python3
"""
This is a Bootstrap script for wrapper.py, in order to retain compatibility with earlier ObzoraNMS setups
"""
...
import ObzoraNMS
import ObzoraNMS.wrapper as wrapper
...
config = ObzoraNMS.get_config_data(os.path.dirname(os.path.realpath(__file__)))
if not config:
...
logger = ObzoraNMS.logger_get_logger(log_file, debug=args.debug)
