...
})->purpose(__('Update ObzoraNMS and run maintenance routines'));
...
', function () {
    ...
    if (empty($this->argument('network')) && ! \App\Facades\ObzoraConfig::has('nets')) {
...
})->purpose(__('Scan the network for hosts and try to add them to ObzoraNMS'));
