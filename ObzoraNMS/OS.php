...
use ObzoraNMS\Interfaces\Discovery\EntityPhysicalDiscovery;
...
use ObzoraNMS\Interfaces\Discovery\StorageDiscovery;
use ObzoraNMS\Interfaces\Discovery\StpInstanceDiscovery;
use ObzoraNMS\Interfaces\Discovery\StpPortDiscovery;
use ObzoraNMS\Interfaces\Discovery\VlanDiscovery;
use ObzoraNMS\Interfaces\Discovery\VlanPortDiscovery;
use ObzoraNMS\Interfaces\Polling\Netstats\IcmpNetstatsPolling;
use ObzoraNMS\Interfaces\Polling\Netstats\IpForwardNetstatsPolling;
use ObzoraNMS\Interfaces\Polling\Netstats\IpNetstatsPolling;
use ObzoraNMS\Interfaces\Polling\Netstats\SnmpNetstatsPolling;
use ObzoraNMS\Interfaces\Polling\Netstats\TcpNetstatsPolling;
use ObzoraNMS\Interfaces\Polling\Netstats\UdpNetstatsPolling;
use ObzoraNMS\Interfaces\Polling\StpInstancePolling;
use ObzoraNMS\Interfaces\Polling\StpPortPolling;
use ObzoraNMS\OS\Generic;
use ObzoraNMS\OS\Traits\BridgeMib;
use ObzoraNMS\OS\Traits\EntityMib;
use ObzoraNMS\OS\Traits\HostResources;
use ObzoraNMS\OS\Traits\NetstatsPolling;
use ObzoraNMS\OS\Traits\QBridgeMib;
use ObzoraNMS\OS\Traits\UcdResources;
use ObzoraNMS\OS\Traits\YamlMempoolsDiscovery;
use ObzoraNMS\OS\Traits\YamlOSDiscovery;
use ObzoraNMS\OS\Traits\YamlStorageDiscovery;
    ...
    VlanPortDiscovery
{
    ...
    public static function make(array &$device): OS
    {
        if (isset($device['os'])) {
            // Populate os_group
            $device['os_group'] = ObzoraConfig::get("os.{$device['os']}.group");

            $class = StringHelpers::toClass($device['os'], 'ObzoraNMS\\OS\\');
            ...
            if ($os_group = ObzoraConfig::get("os.{$device['os']}.group")) {
                $class = StringHelpers::toClass($os_group, 'ObzoraNMS\\OS\\Shared\\');
