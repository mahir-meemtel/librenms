...
class GraphParameters
{
    ...
    public function __construct(array $vars)
    {
        ...
        $this->font = ObzoraConfig::get('mono_font');
    ...
    private function graphColors(): array
    {
        ...
        $def_colors = ObzoraConfig::get($style == 'dark' ? 'rrdgraph_def_text_dark' : 'rrdgraph_def_text');
        $def_font = ltrim(ObzoraConfig::get($style == 'dark' ? 'rrdgraph_def_text_color_dark' : 'rrdgraph_def_text_color'), '#');
