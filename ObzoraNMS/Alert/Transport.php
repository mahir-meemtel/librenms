...
use ObzoraNMS\Interfaces\Alert\Transport as TransportInterface;
...
abstract class Transport implements TransportInterface
{
    ...
    {
        $list = [];
        foreach (glob(base_path('ObzoraNMS/Alert/Transport/*.php')) as $file) {
    ...
    {
        $colors = [
            AlertState::CLEAR => ObzoraConfig::get('alert_colour.ok'),
            AlertState::ACTIVE => ObzoraConfig::get('alert_colour.bad'),
            AlertState::ACKNOWLEDGED => ObzoraConfig::get('alert_colour.acknowledged'),
            AlertState::WORSE => ObzoraConfig::get('alert_colour.worse'),
            AlertState::BETTER => ObzoraConfig::get('alert_colour.better'),
            AlertState::CHANGED => ObzoraConfig::get('alert_colour.changed'),
        ];
    ...
    {
        return 'ObzoraNMS\\Alert\\Transport\\' . ucfirst($type);
    }
