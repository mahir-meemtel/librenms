...
class Wireless implements Module
{
    ...
    {
        $submodules = ObzoraConfig::get('discovery_submodules.wireless', $this->types);
        ...
        foreach ($types as $type) {
            ...
            $sensors = collect($sensors)->map(function (\ObzoraNMS\Device\WirelessSensor $legacy) {
    ...
    public function poll(OS $os, DataStorageInterface $datastore): void
    {
        ...
        $submodules = ObzoraConfig::get('poller_submodules.wireless', []);
    ...
    {
        return StringHelpers::toClass("wireless $type discovery", 'ObzoraNMS\\Interfaces\\Discovery\\Sensors\\');
    }
    ...
    {
        return StringHelpers::toClass("wireless $type polling", 'ObzoraNMS\\Interfaces\\Polling\\Sensors\\');
    }
