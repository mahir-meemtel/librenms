...
class GitHub
{
    ...
    protected $markdown;
    protected $github = 'https://api.github.com/repos/obzora/obzora';
    ...
    public function getPullRequests($date, $after = null)
    {
        ...
        $query = <<<GRAPHQL
{
  search(query: "repo:obzora/obzora is:pr is:merged merged:>=$date", type: ISSUE, first: 100$after) {
    edges {
      node {
        ... on PullRequest {
          number
...
GRAPHQL;
    ...
    {
        $version_file = 'ObzoraNMS/Util/Version.php';
