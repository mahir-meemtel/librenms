...
class Stats
{
    public static function submit(): void
    {
        ...
        if ($stats->isEnabled()) {
            Http::client()
                ->asForm()
                ->post(\App\Facades\ObzoraConfig::get('callback_post'), [
    ...
    public function clearStats(): void
    {
        ...
        $response = Http::client()
            ->asForm()
            ->post(\App\Facades\ObzoraConfig::get('callback_clear'), ['uuid' => $uuid]);
    ...
    private function collectStats(): array
    {
        ...
        return [
            ...
            'obzora_release' => $this->selectStatic($version->release(), 'release'),
        ];
    }
