...
class Rewrite
{
    ...
    public static function location($location)
    {
        ...
        if (is_array(ObzoraConfig::get('location_map_regex'))) {
            foreach (ObzoraConfig::get('location_map_regex') as $reg => $val) {
        ...
        if (is_array(ObzoraConfig::get('location_map_regex_sub'))) {
            foreach (ObzoraConfig::get('location_map_regex_sub') as $reg => $val) {
                if (preg_match($reg, $location)) {
        ...
        if (ObzoraConfig::has("location_map.$location")) {
            $location = ObzoraConfig::get("location_map.$location");
        }
