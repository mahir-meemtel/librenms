...
use ObzoraNMS\Interfaces\Discovery\DiscoveryModule;
use ObzoraNMS\Interfaces\Polling\PollerModule;
...
class Processor extends Model implements DiscoveryModule, PollerModule, DiscoveryItem
{
    ...
    public static function discover(
        ...
        $proc->processor_perc_warn = $warn_percent ?? ObzoraConfig::get('processor_perc_warn', 75);
