...
class ADAuthorizationAuthorizer extends MysqlAuthorizer
{
    ...
    public function __construct()
    {
        ...
        if (ObzoraConfig::has('auth_ad_check_certificates') &&
            ObzoraConfig::get('auth_ad_check_certificates') == 0) {
        ...
        if (ObzoraConfig::has('auth_ad_binduser') && ObzoraConfig::has('auth_ad_bindpassword')) {
            ...
            if (! ldap_bind($this->ldap_connection, ObzoraConfig::get('auth_ad_binduser') . '@' . ObzoraConfig::get('auth_ad_domain'), ObzoraConfig::get('auth_ad_bindpassword'))) {
    ...
    public function authenticate($credentials)
    {
        ...
        if (ObzoraConfig::get('http_auth_guest')) {
            return true;
        }
    ...
    public function getRoles(string $username): array|false
    {
        ...
        // collect all roles
        $auth_ad_groups = ObzoraConfig::get('auth_ad_groups');
