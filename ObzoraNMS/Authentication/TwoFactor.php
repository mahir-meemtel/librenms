...
class TwoFactor
{
    ...
    {
        $title = 'ObzoraNMS:' . urlencode($username);

        return $counter ?
            "otpauth://hotp/$title?issuer=ObzoraNMS&counter=1&secret=$key" : // counter based
            "otpauth://totp/$title?issuer=ObzoraNMS&secret=$key"; // time based
    }
}
