<?php
namespace ObzoraNMS\Interfaces\Authentication;
...
interface Authorizer
{
    ...
    /**
     * Indicates if the authentication happens within the ObzoraNMS process, or external to it.
     * If the former, ObzoraNMS provides a login form, and the user must supply the username. If the latter, the authenticator supplies it via getExternalUsername() without user interaction.
     * This is an important distinction, because at the point this is called if the authentication happens out of process, the user is already authenticated and ObzoraNMS must not display a login form - even if something fails.
     *
     * @return bool
     */
