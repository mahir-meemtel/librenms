    ...
    public function validate(): ValidationResult
    {
        ...
        if (empty($collation) !== true) {
            return ValidationResult::fail(
                ...
                'Check https://community.obzora.meemtel.com/t/new-default-database-charset-collation/14956 for info on how to fix.'
            )->setFixer(__CLASS__);
        }
        ...
        if (empty($collation_tables) !== true) {
            return ValidationResult::fail('MySQL tables collation is wrong: ')
                ->setFix('Check https://community.obzora.meemtel.com/t/new-default-database-charset-collation/14956 for info on how to fix.')
                ->setFixer(__CLASS__)
