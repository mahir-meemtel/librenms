...
[![Build Status](https://travis-ci.org/obzora/laravel-vue-i18n-generator.png?branch=master)](https://travis-ci.org/obzora/laravel-vue-i18n-generator)
...
In your project:
```composer require obzora/laravel-vue-i18n-generator --dev```
