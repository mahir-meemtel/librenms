<?php
namespace ObzoraNMS\Interfaces\Plugins;
...
interface PluginManagerInterface
{
     ...
     *
     * @param string $pluginName Interface from ObzoraNMS\Interfaces\Plugins\Hooks
     ...
     *
     * @param string $hookType Interface from ObzoraNMS\Interfaces\Plugins\Hooks
     * @param array $args
