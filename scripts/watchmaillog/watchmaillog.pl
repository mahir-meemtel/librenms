...
$self="/opt/obzora/scripts/watchmaillog/watchmaillog.sh";			# Location of this script
$counterfile="/opt/obzora/scripts/watchmaillog/watchmaillog_counters";	# Location to store the counter file
$resetfile="/opt/obzora/scripts/watchmaillog/watchmaillog_reset";		# Location of the reset counter flag file
