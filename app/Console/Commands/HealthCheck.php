...
use ObzoraNMS\Validations\Database\CheckDatabaseConnected;
use ObzoraNMS\Validations\Poller\CheckRedis;
    ...
    public function handle(): int
    {
        ...
        if (EnvHelper::obzoraDocker()) {
            if (getenv('SIDECAR_DISPATCHER')) {
                // check dispatcher
                $health_file = \App\Facades\ObzoraConfig::get('service_health_file');
