...
class DeviceAdd extends LnmsCommand
{
    ...
    public function __construct()
    {
        ...
        $this->optionValues = [
            ...
            'auth-protocol' => [\ObzoraNMS\SNMPCapabilities::class, 'supportedAuthAlgorithms'],
            'privacy-protocol' => [\ObzoraNMS\SNMPCapabilities::class, 'supportedCryptoAlgorithms'],
        ];

        $this->optionDefaults = [
            'port' => function () {
                return ObzoraConfig::get('snmp.port', 161);
            },
            'transport' => function () {
                return ObzoraConfig::get('snmp.transports.0', 'udp');
            },
            'poller-group' => function () {
                return ObzoraConfig::get('default_poller_group');
            },
            'port-association-mode' => function () {
                return ObzoraConfig::get('default_port_association_mode');
            },
