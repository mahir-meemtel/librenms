...
class CustomMapController extends Controller
{
    ...
    public function index(): View
    {
        return view('map.custom-manage', [
            ...
            'name' => 'New Map',
            'menu_group' => null,
            'node_align' => ObzoraConfig::get('custom_map.node_align', 10),
            'edge_separation' => ObzoraConfig::get('custom_map.edge_seperation', 10),
            'reverse_arrows' => ObzoraConfig::get('custom_map.reverse_arrows', false) ? 'true' : 'false',
            'legend' => [
                'x' => -1,
                'y' => -1,
            ],
            'background_type' => ObzoraConfig::get('custom_map.background_type', 'none'),
            'background_data' => ObzoraConfig::get('custom_map.background_data'),
            'map_conf' => [
                'width' => ObzoraConfig::get('custom_map.width', '1800px'),
                'height' => ObzoraConfig::get('custom_map.height', '800px'),
                'interaction' => [
                    'dragNodes' => true,
                    'dragView' => false,
                    'zoomView' => false,
    ...
    public function show(Request $request, CustomMap $map): View
    {
        ...
        return view('map.custom-view', [
            ...
            'map_conf' => $map_conf,
            'base_url' => ObzoraConfig::get('base_url'),
    ...
    public function store(CustomMapSettingsRequest $request): JsonResponse
    {
        ...
        $map->newnodeconfig = [
            'borderWidth' => 1,
            'color' => [
                'border' => ObzoraConfig::get('custom_map.node_border', '#2B7CE9'),
                'background' => ObzoraConfig::get('custom_map.node_background', '#D2E5FF'),
            ],
            'font' => [
                'color' => ObzoraConfig::get('custom_map.node_font_color', '#343434'),
                'size' => ObzoraConfig::get('custom_map.node_font_size', 14),
                'face' => ObzoraConfig::get('custom_map.node_font_face', 'arial'),
            ],
            'icon' => [],
            'label' => true,
            'shape' => ObzoraConfig::get('custom_map.node_type', 'box'),
            'size' => ObzoraConfig::get('custom_map.node_size', 25),
        ];
        $map->newedgeconfig = [
            'arrows' => [
                'to' => [
            ...
            'font' => [
                'color' => ObzoraConfig::get('custom_map.edge_font_color', '#343434'),
                'size' => ObzoraConfig::get('custom_map.edge_font_size', 12),
                'face' => ObzoraConfig::get('custom_map.edge_font_face', 'arial'),
                'align' => ObzoraConfig::get('custom_map.edge_font_align', 'horizontal'),
            ],
            'label' => true,
        ];
        $map->background_type = ObzoraConfig::get('custom_map.background_type', 'none');
        $map->background_data = ObzoraConfig::get('custom_map.background_data');
    ...
    {
        $ret = ObzoraConfig::get('custom_map.legend_colours', null);
