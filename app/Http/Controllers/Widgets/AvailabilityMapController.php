...
class AvailabilityMapController extends WidgetController
{
    ...
    public function __construct()
    {
        $this->defaults = [
            'title' => null,
            'type' => (int) ObzoraConfig::get('webui.availability_map_compact', 0),
            'tile_size' => 12,
            'color_only_select' => 0,
            'show_disabled_and_ignored' => 0,
            'mode_select' => 0,
            'order_by' => ObzoraConfig::get('webui.availability_map_sort_status') ? 'status' : 'display-name',
            'device_group' => null,
        ];
    }
    ...
    private function getDevices(): array
    {
        ...
        // process status
        $uptime_warn = (int) ObzoraConfig::get('uptime_warning', 86400);
