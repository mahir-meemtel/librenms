...
class GlobeController extends WidgetController
{
    ...
    public function __construct()
    {
        ...
        $this->defaults = [
            'title' => null,
            'markers' => ObzoraConfig::get('frontpage_globe.markers', 'devices'),
            'region' => ObzoraConfig::get('frontpage_globe.region', 'world'),
            'resolution' => ObzoraConfig::get('frontpage_globe.resolution', 'countries'),
            'device_group' => null,
        ];
    }
