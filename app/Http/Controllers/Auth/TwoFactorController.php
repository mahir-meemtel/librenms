...
use ObzoraNMS\Authentication\TwoFactor;
...
class TwoFactorController extends Controller
{
    ...
    public function showTwoFactorForm(Request $request)
    {
        ...
        if (empty($twoFactorSettings) || ! ObzoraConfig::get('twofactor') || session('twofactor')) {
            return redirect()->intended();
        }
        ...
        if (isset($twoFactorSettings['fails']) && $twoFactorSettings['fails'] >= 3) {
            $lockout_time = ObzoraConfig::get('twofactor_lock', 0);
