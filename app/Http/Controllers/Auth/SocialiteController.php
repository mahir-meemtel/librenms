...
class SocialiteController extends Controller
{
    ...
    public function redirect(Request $request, string $provider)
    {
        ...
        if ($driver instanceof \Laravel\Socialite\Two\AbstractProvider) {
            $scopes = ObzoraConfig::get('auth.socialite.scopes');
    ...
    {
        if (! ObzoraConfig::get('auth.socialite.register', false)) {
            return;
        }
        ...
        $default_role = ObzoraConfig::get('auth.socialite.default_role');
    ...
    {
        $scopes = ObzoraConfig::get('auth.socialite.scopes');
        $claims = ObzoraConfig::get('auth.socialite.claims');
    ...
    /**
     * Take the config from Obzora Config, and insert it into Laravel Config
     */
    private function injectConfig(): void
    {
        foreach (ObzoraConfig::get('auth.socialite.configs', []) as $provider => $config) {
