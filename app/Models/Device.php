...
class Device extends BaseModel
{
    ...
    public function displayName(): string
    {
        ...
        return SimpleTemplate::parse($this->display ?: \App\Facades\ObzoraConfig::get('device_display_default', '{{ $hostname }}'), [
    ...
    public function shortDisplayName($length = 12)
    {
        ...
        $length = \App\Facades\ObzoraConfig::get('shorthost_target_length', $length);
